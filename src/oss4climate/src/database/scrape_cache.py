...
_SCRAPE_CACHE_ENGINE = _open_engine_and_create_database_if_missing()
...
def load_from_scrape_cache(
    ...
    """
    with Session(_SCRAPE_CACHE_ENGINE) as session:
...
def save_to_scrape_cache(key: str, value: dict, is_json: bool) -> None:
    """
